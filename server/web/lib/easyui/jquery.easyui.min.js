...
setTimeout(function(){
try { win.window("destroy"); } catch (ex) {}
},100);
}}));
...
window.fixGridLoadPerf=true; // >>>> lj:perfix: grid loading is slow when it has many columns
...
if (window.fixGridLoadPerf) {
$(_626).datagrid("fixColumnSize");
window.fixGridLoadPerf=false;
}
...
if(_633){
if (window.fixGridLoadPerf) return;
fix(_633);
}else{
